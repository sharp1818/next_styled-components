...
import { FormBox, ServiceBox } from "../styles/servicios/style";
...
export const getServerSideProps = async (context) => {
  ...
  const product1 = await axios.get(
    "http://localhost:3000/api/servicios/category1"
  );
  const product2 = await axios.get(
    "http://localhost:3000/api/servicios/category2"
  );
  const product3 = await axios.get(
    "http://localhost:3000/api/servicios/category3"
  );
  const product4 = await axios.get(
    "http://localhost:3000/api/servicios/category4"
  );
  const product5 = await axios.get(
    "http://localhost:3000/api/servicios/category5"
  );
  const product6 = await axios.get(
    "http://localhost:3000/api/servicios/category6"
  );
